...
<div id="app mdui-container">
  ...
  <div class="footer mdui-card mdui-col-xs-12">
      <ul class="social-buttons">
        <li><a href="https://github.com/wanglu58/" target="_blank"><img src="./assets/img/footer/github.svg" alt="" width="24px" height="24px;"></a></li>
        <li><a href="https://www.xkblogs.com/" target="_blank"><img src="./assets/img/footer/about.svg" alt="" width="24px" height="24px;"></i></a></li>
      </ul>
...
$(document).ready(function() {
  ...
  // Weather
  var cityid = 101190101;
  var cityid = Store.getCookie('cityid');
  var weather=$.ajax({url:"http://www.94994.com/myapp/weather/data/index.php?cityID=" + cityid, async:false});
...
if (!Store.getCookie('visited')) {
  if(Store.fetch_site().length == 0){
    ...
    //   {
      ...
      // },
        ...
        {
            "url": "https://wanglu.cloud:888",
            "title": "群辉Nas",
            "icon": require('./assets/img/icons/nas.png')
        },
        {
            "url": "http://wanglu.cloud:666",
            "title": "个人云盘",
        ...
        },
        {
            ...
            "title": "Netflix",
            "icon": require('./assets/img/icons/netflix.png')
        },
        {
  ...
  Store.setCookie("se", "baidu", 365);
  Store.setCookie("visited", "true", 365);
  if(!Store.getCookie("cityid")){
    Store.setCookie("cityid", 101190101, 365);
  }
}
